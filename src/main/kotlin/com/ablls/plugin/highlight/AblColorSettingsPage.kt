    ...
    private val descriptors =
        arrayOf(
            ...
            AttributesDescriptor(
                "Keyword//Flow control (IF, DO, FOR, END...)",
                AblSyntaxHighlighter.KEYWORD_FLOW,
            ),
            AttributesDescriptor(
                "Keyword//Definition (DEFINE, CLASS, METHOD...)",
                AblSyntaxHighlighter.KEYWORD_DEF,
            ),
            AttributesDescriptor(
                "Keyword//Database (FIND, FOR EACH, WHERE...)",
                AblSyntaxHighlighter.KEYWORD_DB,
            ),
            AttributesDescriptor(
                "Keyword//Access modifier (PUBLIC, PRIVATE, STATIC...)",
                AblSyntaxHighlighter.KEYWORD_MOD,
            ),
            AttributesDescriptor(
                "Keyword//Primitive type (CHARACTER, INTEGER...)",
            ...
            AttributesDescriptor(
                "Logical literal (TRUE/FALSE/YES/NO/?)",
