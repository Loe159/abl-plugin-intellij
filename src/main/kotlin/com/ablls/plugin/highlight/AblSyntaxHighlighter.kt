...
class AblSyntaxHighlighter : SyntaxHighlighterBase() {
    companion object {
        ...
        @JvmField val KEYWORD_FLOW =
            createTextAttributesKey(
                "ABL_KEYWORD_FLOW",
                Default.KEYWORD,
            )

        @JvmField val KEYWORD_DEF =
            createTextAttributesKey(
                "ABL_KEYWORD_DEF",
                Default.FUNCTION_DECLARATION,
            )

        @JvmField val KEYWORD_DB =
            createTextAttributesKey(
                "ABL_KEYWORD_DB",
                Default.CONSTANT,
            )

        @JvmField val KEYWORD_MOD =
            createTextAttributesKey(
                "ABL_KEYWORD_MOD",
                Default.METADATA,
            )

        @JvmField val KEYWORD_TYPE =
            createTextAttributesKey(
                "ABL_KEYWORD_TYPE",
                Default.CLASS_NAME,
            )
        ...
        @JvmField val LOGICAL_LITERAL =
            createTextAttributesKey(
                "ABL_LOGICAL_LITERAL",
                Default.KEYWORD,
            )

        @JvmField val BLOCK_COMMENT =
            createTextAttributesKey(
                "ABL_BLOCK_COMMENT",
                Default.BLOCK_COMMENT,
            )

        @JvmField val LINE_COMMENT =
            createTextAttributesKey(
                "ABL_LINE_COMMENT",
                Default.LINE_COMMENT,
            )

        @JvmField val PREPROCESSOR =
            createTextAttributesKey(
                "ABL_PREPROCESSOR",
                Default.METADATA,
            )
        ...
        @JvmField val ANNOTATION =
            createTextAttributesKey(
                "ABL_ANNOTATION",
                Default.METADATA,
            )

        @JvmField val BAD_CHARACTER =
            createTextAttributesKey(
                "ABL_BAD_CHARACTER",
