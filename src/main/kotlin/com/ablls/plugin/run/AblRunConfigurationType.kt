...
class AblRunConfigurationFactory(type: ConfigurationType) : ConfigurationFactory(type) {
    ...
    override fun createTemplateConfiguration(project: Project): RunConfiguration = AblRunConfiguration(project, this)
}
...
class AblRunConfiguration(
    ...
    override fun getConfigurationEditor(): SettingsEditor<out RunConfiguration> = AblRunConfigurationEditor()
