...
class AblCallHierarchyProvider : HierarchyProvider {
    ...
    override fun getTarget(dataContext: DataContext): PsiElement? {
        ...
        val isCallable = service.symbolIndex.findByName(word, uri).any { sym ->
    ...
    override fun createHierarchyBrowser(target: PsiElement): HierarchyBrowser =
        AblCallHierarchyBrowser(target.project, target)
...
class AblCallHierarchyBrowser(
     ...
     */
    private fun buildCallers(procName: String, root: DefaultMutableTreeNode, service: AblProjectAnalysisService) {
     ...
     */
    private fun buildCallees(procName: String, root: DefaultMutableTreeNode, service: AblProjectAnalysisService) {
        val targetSym = service.symbolIndex.findByName(procName, "")
        ...
        calleeNames.forEach { calleeName ->
            val calleeSym = service.symbolIndex.findByName(calleeName, "")
                .firstOrNull { it.kind == AblSymbol.Kind.PROCEDURE || it.kind == AblSymbol.Kind.FUNCTION }
