        ...
        object : PsiElementVisitor() {
            override fun visitFile(file: PsiFile) {
                ...
                for (defineNode in topNode.queryStateHead(ABLNodeType.DEFINE)) {
                    ...
                    val nodeType2 =
                        runCatching { defineNode.asIStatement().nodeType2 }.getOrNull()
                            ?: continue
                    ...
                    val msg =
                        if (isVariable) {
                            "Missing NO-UNDO modifier on VARIABLE (affects performance)"
                        } else {
                            "Missing NO-UNDO modifier on TEMP-TABLE (affects performance)"
                        }
