...
class AblPostfixTemplateProvider : PostfixTemplateProvider {
    ...
    private val _templates: Set<PostfixTemplate> by lazy {
        setOf(
    ...
    override fun getTemplates(): Set<PostfixTemplate> = _templates

    override fun isTerminalSymbol(currentChar: Char): Boolean = currentChar == '.'

    override fun preExpand(file: PsiFile, editor: Editor) { /* no-op */ }

    override fun preCheck(file: PsiFile, editor: Editor, offset: Int): PsiFile = file

    override fun afterExpand(file: PsiFile, editor: Editor) { /* no-op */ }
}
...
private class AblPostfixTemplate(
    ...
    /* name     */ key,
    /* example  */ example,
    /* selector */ AblExpressionSelector,
    /* provider */ provider
) {
...
private object AblExpressionSelector : PostfixTemplateExpressionSelector {
    ...
    override fun getRenderer(): com.intellij.util.Function<PsiElement, String> =
        com.intellij.util.Function { e -> e.text ?: "" }
}
