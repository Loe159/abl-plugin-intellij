...
MODULE_PATH = CHECKS_DIR / "check_draft_pr_publication_readiness.py"
sys.path.insert(0, str(CHECKS_DIR))
SPEC = importlib.util.spec_from_file_location(
    "check_draft_pr_publication_readiness",
    MODULE_PATH,
)
...
class CheckDraftPrPublicationReadinessTest(unittest.TestCase):
    def test_policy_is_exact_local_preflight_only(self) -> None:
        ...
        self.assertIn("explicit_publication_request", policy["required_missing_controls"])
        self.assertIn("validated_quality_gate_receipt", policy["required_missing_controls"])
    ...
    def test_policy_drift_and_cli_override_are_rejected(self) -> None:
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            value["required_missing_controls"] = []
